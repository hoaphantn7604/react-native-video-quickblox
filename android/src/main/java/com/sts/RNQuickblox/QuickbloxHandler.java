...
//        this.quickbloxClient.setupQuickblox(APP_ID, AUTH_KEY, AUTH_SECRET, ACCOUNT_KEY);
    ...
    public void init() {
        ...
        QBRTCClient.getInstance(reactApplicationContext).addSessionCallbacksListener(new QBRTCClientSessionCallbacks() {
            ...
            public void onReceiveNewSession(QBRTCSession qbrtcSession) {
                ...
                Log.i(TAG, "log____: " + qbrtcSession.getUserInfo());
                //[self.localViewManager attachLocalCameraStream:self.session];
                quickbloxClient.receiveCallSession(session, qbrtcSession.getUserInfo());
            }
    ...
    public void startCall(List<Integer> userIDs, String callRequestId, String realName, String avatar) {
        ...
        userInfo.put("callRequestId", callRequestId);
